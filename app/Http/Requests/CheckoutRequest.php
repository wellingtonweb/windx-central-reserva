...
//            'bandeira' =>           ['required_if:payment_type,credit,debit','string'],
            'billets' =>            ['required'],
//            'card_number' =>        ['required_if:payment_type,credit,debit', new CardNumber],
//            'expiration_year' =>    ['required_if:payment_type,credit,debit', new CardExpirationYear($this->get('expiration_month'))],
//            'expiration_month' =>   ['required_if:payment_type,credit,debit', new CardExpirationMonth($this->get('expiration_year'))],
//            'cvv' =>                ['required_if:payment_type,credit,debit', new CardCvc($this->get('card_number'))],
//            'card_number' =>        ['required_if:payment_type,credit,debit','size:16',
...
//            'holder_name' =>        ['required_if:payment_type,credit,debit'],
            ...
            'cpf_cnpj' =>           ['required_if:method,picpay,pix','string'],
            'cpf_cnpj_type' =>      ['required_if:method,pix','string'],
