...
var BP = function () {
    ...
    function s() {
        ...
        const a = (new Date).getTimezoneOffset(), s = {
            userAgent: i,
            screenWidth: e,
            screenHeight: n,
            colorDepth: r,
    ...
    function l() {
        return {orderNumber: n("bpmpi_ordernumber"), currency: n("bpmpi_currency"), amount: n("bpmpi_totalamount")}
    }
    ...
    function f(e, n) {
        T = n, g("[MPI]", "Initializing..."), g("[MPI]", "Token =", e), g("[MPI]", "ReferenceId =", T), Cardinal.configure({
            ...
            logging: {level: h()}
        }), Cardinal.setup("init", {jwt: e}), Cardinal.on("payments.setupComplete", function (e) {
    ...
    function C(e, r, i) {
        var t = JSON.stringify(r), o = new XMLHttpRequest;
    ...
    function P(e) {
        ...
        if (n.cart) for (var t = 0; t < n.cart.length; t++) r.Cart.push({
    ...
    function R(e) {
        ...
        var i = {AcsUrl: e.AcsUrl, Payload: e.Pareq, TransactionId: e.AuthenticationTransactionId},
    ...
    var D = c(),
        ...
        T = null, X = null, k = {
            Number: null, Description: null, HasError: function () {
