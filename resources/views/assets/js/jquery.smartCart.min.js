...
!(function (t, e, a, i) {
    ...
    var r = {
        ...
        combineProducts: !0,
        highlightEffect: !0,
        cartItemTemplate: '<img class="img-responsive pull-left" src="{product_image}" /><h4 class="list-group-item-heading">{reference_id}</h4><p class="list-group-item-text">{reference}</p>',
        // cartItemQtyTemplate: "{display_price} × {display_quantity} = {display_amount}",
        cartItemQtyTemplate: "{display_amount}",
        productContainerSelector: ".sc-product-item",
        productElementSelector: "*",
        addCartSelector: ".sc-add-to-cart",
        // paramSettings: { productPrice: "product_price", productQuantity: "product_quantity", productName: "product_name", productId: "product_id" },
        paramSettings: { productPrice: "value", productQuantity: "product_quantity", productName: "addition", productId: "reference" },
        lang: { cartTitle: "Boletos a pagar: ", checkout: "Avançar", clear: "Cancelar", subtotal: "Valor total:", cartRemove: "×", cartEmpty: "Não existem boletos selecionados!" },
        submitSettings: { submitType: "form", ajaxURL: "", ajaxSettings: {} },
        currencySettings: { locales: "pt-BR", currencyOptions: { style: "currency", currency: "BRL", currencyDisplay: "symbol" } },
        toolbarSettings: { showToolbar: !0, showCheckoutButton: !0, showClearButton: !0, showCartSummary: !0, checkoutButtonStyle: "default", checkoutButtonImage: "", toolbarExtraButtons: [] },
        debug: !1,
    };
    t.extend(s.prototype, {
        ...
        _setElements: function () {
            ...
            this.cart_element.append(e),
                // this.cart_element.addClass("panel panel-default sc-cart sc-theme-" + this.options.theme),
                this.cart_element.addClass("panel-footer sc-toolbar sc-theme-" + this.options.theme),
                this.cart_element.append('<div class="heading"><h4 class="panel-heading align-items-center sc-cart-heading">' + this.options.lang.cartTitle + '<span class="sc-cart-count badge badge-pill badge-primary">0</span></h4></div>');
            this.cart_element.append('<div class="list-group sc-cart-item-list d-none"></div>');
        },
        _setToolbar: function () {
            ...
            if (this.options.toolbarSettings.showClearButton) {
                var r = t('<button class="btn btn-danger btn-lg sc-cart-clear mr-2" type="button"><i class="fas fa-times pr-1"></i>').text(this.options.lang.clear);
                a.append(r);
            }
            if (this.options.toolbarSettings.showCheckoutButton) {
                ...
                switch (this.options.toolbarSettings.checkoutButtonStyle) {
                    ...
                    case "image":
                        ...
                        break;
                    default:
                        s = '<button class="btn btn-success btn-lg sc-cart-checkout load" type="button">' + this.options.lang.checkout + "<i class='fas fa-arrow-right pl-1'></i></button> ";
                }
                a.append(s);
            }
            if ((this.options.toolbarSettings.toolbarExtraButtons && this.options.toolbarSettings.toolbarExtraButtons.length > 0 && a.append(this.options.toolbarSettings.toolbarExtraButtons), this.options.toolbarSettings.showCartSummary)) {
                ...
                n.append(this.options.lang.subtotal).append(' <span class="sc-cart-subtotal font-weight-bold">0</span>'), i.append(n);
            }
        ...
        _setEvents: function () {
            ...
            t(this.options.addCartSelector).on("click", function (a) {
                ...
                t(this.cart_element).on("click", ".sc-cart-clear", function (a) {
                    if (t(this).hasClass("disabled")) return !1;
                    a.preventDefault(),
                        t(".sc-cart-item-list > .sc-cart-item", this.cart_element).fadeOut("normal", function () {
        ...
        _addToCart: function (e) {
            var a = this;
            if (!e.hasOwnProperty(this.options.paramSettings.productPrice)) return this._logError("O preço não está definido para o item"), !1;
            if (
                (e.hasOwnProperty(this.options.paramSettings.productQuantity) || (this._logMessage("Mínimo de boletos: 1"), (e[this.options.paramSettings.productQuantity] = 1)),
                e.hasOwnProperty("unique_key") || (e.unique_key = this._getUniqueKey()),
                    this.options.combineProducts)
            ) {
                // var i = t.grep(this.cart, function (t, i) {
                var i = t.grep(this.cart, function (t) {
                    return a._isObjectsEqual(t, e);
                });
                if (i.length > 0) {
                    var s = this.cart.indexOf(i[0]);
                    // (this.cart[s][this.options.paramSettings.productQuantity] = this.cart[s][this.options.paramSettings.productQuantity] - 0 + (e[this.options.paramSettings.productQuantity] - 0)),
                        (e = this.cart[s]),
                        this._triggerEvent("itemUpdated", [e]);
        ...
        _addUpdateCartItem: function (e) {
            ...
            if (s && s.length > 0) s.find(".sc-cart-item-qty").val(e[this.options.paramSettings.productQuantity]), s.find(".sc-cart-item-amount").text(this._getMoneyFormatted(a));
                ...
                //REMOVIDO O ADICIONAR ITEM NO CARRINHO DE COMPRAS
                (s = t("<div class='text-left border-bottom'></div>").addClass("sc-cart-item list-group-item border-0")),
                    s.append('<button type="button" class="sc-cart-remove float-right">' + this.options.lang.cartRemove + "</button>"),
                    // s.append('<button type="button" class="sc-cart-remove "><i class="fas fa-trash-alt"></i></button>'),
                    s.attr("data-unique-key", e.unique_key),
                    s.append(this._formatTemplate(this.options.cartItemTemplate, e));
                ...
                // (r += ' × <input type="number" min="1" max="1000" class="sc-cart-item-qty" value="' + this._getValueOrEmpty(e[this.options.paramSettings.productQuantity]) + '" />'),
                //     (r += ' = <span class="sc-cart-item-amount">' + this._getMoneyFormatted(a) + "</span></div>"),
                //     s.append(r),
                //     i.append(s);

                // Modificado e funcionando
                var r = '<div class="sc-cart-item-summary"><span class="sc-cart-item-price">' + this._getMoneyFormatted(e[this.options.paramSettings.productPrice]) + "</span></div>";
                // (r += ' × <input type="number" min="1" max="1000" class="sc-cart-item-qty" value="' + this._getValueOrEmpty(e[this.options.paramSettings.productQuantity]) + '" />'),
                s.append(r),
                i.append(s);

            }
            this.options.highlightEffect === !0 &&
            (s.addClass("sc-highlight"),
                setTimeout(function () {
        ...
        _hasCartChange: function () {
            t(".sc-cart-count", this.cart_element).text(this.cart.length),
                t(".sc-cart-subtotal", this.element).text(this._getCartSubtotal()),
                0 === this.cart.length
                    ? (t(".sc-cart-item-list", this.cart_element)
                        .empty(),
                        // .append(t('<div class="sc-cart-empty-msg">' + this.options.lang.cartEmpty + "</div>")),
                        t(this.options.productContainerSelector).removeClass("sc-added-item"),
                        t(".sc-cart-checkout, .sc-cart-clear").addClass("disabled"),
                        t(".sc-add-to-cart, .sc-print-billet").attr("disabled", false),
                        this._triggerEvent("cartEmpty"))
                    : (t(".sc-cart-item-list > .sc-cart-empty-msg", this.cart_element).remove(), t(".sc-cart-checkout, .sc-cart-clear").removeClass("disabled")),
                // t("#" + this.options.resultName, this.cart_element).val(this.cart);
                t("#" + this.options.resultName, this.cart_element).val(JSON.stringify(this.cart));
        },
        _getCartSubtotal: function () {
            var e = this,
                a = 0;
            return (
                t.each(this.cart, function (t, i) {
        ...
        _submitCart: function () {
            ...
            console.log(e);
            if (!a) return this._logError("Formulário sem conteúdo!"), !1;
            switch (this.options.submitSettings.submitType) {
                case "ajax":
                    ...
                    break;
                case "paypal":
                    a.children(".sc-paypal-input").remove(),
                        t.each(this.cart, function (t, i) {
                            var s = t + 1;
                            a.append('<input class="sc-paypal-input" name="item_number_' + s + '" value="' + e._getValueOrEmpty(i[e.options.paramSettings.productId]) + '" type="hidden">')
                                .append('<input class="sc-paypal-input" name="item_name_' + s + '" value="' + e._getValueOrEmpty(i[e.options.paramSettings.productName]) + '" type="hidden">')
                                .append('<input class="sc-paypal-input" name="amount_' + s + '" value="' + e._getValueOrEmpty(i[e.options.paramSettings.productPrice]) + '" type="hidden">')
                                .append('<input class="sc-paypal-input" name="quantity_' + s + '" value="' + e._getValueOrEmpty(i[e.options.paramSettings.productQuantity]) + '" type="hidden">');
                        }),
                        a.submit(),
        ...
        _isObjectsEqual: function (t, e) {
            ...
            for (var a in t) if ("unique_key" !== a && a !== this.options.paramSettings.productQuantity && (void 0 !== t[a] || void 0 !== e[a]) && t[a] !== e[a]) return !1;
            return !0;
        },
        ...
        (t.fn.smartCart = function (e) {
            ...
            return void 0 === e || "object" == typeof e
                ...
                : "string" == typeof e && "_" !== e[0] && "init" !== e
                    ? ((a = t.data(this[0], "smartCart")), "destroy" === e && t.data(this, "smartCart", null), a instanceof s && "function" == typeof a[e] ? a[e].apply(a, Array.prototype.slice.call(i, 1)) : this)
                    : void 0;
        });
