...
!(function (t, e, a, i) {
    ...
    var r = {
        ...
        lang: { cartTitle: "Shopping Cart", checkout: "CheckoutJob", clear: "Clear", subtotal: "Subtotal:", cartRemove: "×", cartEmpty: "Cart is Empty!<br />Choose your products" },
        submitSettings: { submitType: "form", ajaxURL: "", ajaxSettings: {} },
        currencySettings: { locales: "en-US", currencyOptions: { style: "currency", currency: "USD", currencyDisplay: "symbol" } },
    ...
    t.extend(s.prototype, {
        ...
        _addToCart: function (e) {
            ...
            if (
                (e.hasOwnProperty(this.options.paramSettings.productQuantity) || (this._logMessage("Quantity not found, default to 1"), (e[this.options.paramSettings.productQuantity] = 1)),
        ...
        _addUpdateCartItem: function (e) {
            ...
            if (s && s.length > 0) s.find(".sc-cart-item-qty").val(e[this.options.paramSettings.productQuantity]), s.find(".sc-cart-item-amount").text(this._getMoneyFormatted(a));
                ...
                (s = t("<div></div>").addClass("sc-cart-item list-group-item")),
                    s.append('<button type="button" class="sc-cart-remove">' + this.options.lang.cartRemove + "</button>"),
