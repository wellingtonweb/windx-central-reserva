...
{{--                                    </li>--}}
                                ...
                                <div class="flex-container d-none">
                                    ...
                                    <div class="flex-item">
                                        <button id="btn-picpay" type="button" class="btn btn-windx">PicPay</button>
                                    </div>
                                    <div class="flex-item">
                                        <button id="btn-credit" type="button" class="btn btn-windx">Crédito</button>
                                    </div>
                                    <div class="flex-item">
                                        <button id="btn-credit" type="button" class="btn btn-windx">Crédito</button>
                                    </div>
                                ...
                                <div class="checkout-controls">
                                        ...
                                        <div class="col-12">
                                            <div class="tab-content" id="v-pills-tabContent">
                                                <div class="tab-pane fade justify-content-center" id="v-pills-qrcode" role="tabpanel" aria-labelledby="v-pills-home-tab">
                                                    <div class=""><h4>Preencha com seus dados</h4></div>
                                                    ...
                                                    <a href="javascript:void(0)" type="button" class="text-black-50 p-2">
                                    ...
                                    <div id="container-dataform" class="payment-item d-none">
                                    ...
                                    <div id="container-options" class="payment-item d-none">
                                        <div class="item-title">Forma de pagamento</div>
                                        <div class="item-options">
                                            <div class="selection">
                                                <input type="radio" name="support" id="pix" checked="checked"/>
                                                <label for="pix">PIX<span></span></label>
                                                <div class="check"></div>
                                            </div>
                                            <div class="selection">
                                                <input type="radio" name="support" id="picpay"/>
                                                <label for="picpay">PICPAY<span></span></label>
                                                <div class="check"></div>
                                            </div>
                                            <div class="selection">
                                                <input type="radio" name="support" id="credit"/>
                                                <label for="credit">CRÉDITO<span></span></label>
                                                <div class="check"></div>
                                            </div>
                                            <div class="selection">
                                                <input type="radio" name="support" id="debit"/>
                                                <label for="debit">DÉBITO<span></span></label>
                                                <div class="check"></div>
                                            </div>
                                        </div>
                                    </div>
...
{{--                                        </li>--}}
{{--                                        <li class="list-group-item d-flex justify-content-between lh-condensed">--}}
{{--                                            <button id="btn-debit" type="button" class="btn btn-windx">Débito</button>--}}
{{--                                        </li>--}}
{{--                                    </ul>--}}
