        ...
        function checkTerms()
        {
            ...
            if(!terms){
                ...
                Swal.fire({
                    title: 'Informativo!',
                    html:`
                        <p>Este site utiliza cookies para proporcionar uma melhor navegação a você! Em caso de dúvidas,
