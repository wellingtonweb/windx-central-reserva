        ...
        <section>
            <div class="container-fluid container-payment">
                <main role="main" class="inner fadeIn">
                    <div class="d-none row contents animate__animated animate__fadeIn">
...
{{--                                            </button>--}}
                    ...
                    <div class="row"><div class="qrcode-test"></div></div>
                </main>
            </div>
        </section>
    </main>
    ...
    <script>
        ...
        var content = `
            <div id="modal-qrcode" class="bg-white text-center justify-content-center">
                <div class="box-price-qrcode-card pb-1">
                    <h2 class="text-danger pt-2 "><b>R$ </b><span class="font-weight-bold">1,00</span></h2>
                    <p>Faturas selecionadas: <strong class="total-count"></strong></p>
                </div>
                <p class="pt-2">Leia o QRCode com seu app</p>
                <div id="container-qrcode">
                    <div class="body-popup-qrcode">
                        <div class="qrcode-container">
        ...
        <div class="form-floating group-pix-copy-paste">
            ...
            <label for="pixcopypaste">Código do Pix Copia e Cola</label>
                    ...
                    <p id="btnPixCopyPaste" class="animate__animated text-primary d-none_" onclick="pixCopyPaste(this)" data-code="00020101021226890014br.gov.bcb.pix2567qrcodes.cielo.com.br\/pix-qr\/v2\/eecafa95-3012-4e1f-a1d8-ebba372192ef5204000053039865802BR5925PENHA DE SOUZA JAMARIQUEL6010MARATAIZES62070503***6304419E">
                    Copiar código do PIX
                    </p>
                </div>
                <p id="labelWaitingPayment" class="pt-3 text-black-50 animate__animated animate__fadeIn d-none"></p>
                <p id="timerPaymentQrCode" class="text-danger"></p>
            </div>
            `;
        // $('.qrcode-test').html(content)

        Swal.fire({
            title: 'Pagamento com PIX',
            html: content,
            text: 'Use o botão copia e cola',
