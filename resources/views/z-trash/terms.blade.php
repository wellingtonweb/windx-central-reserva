    ...
    <main>
        <section>
            <div class="container">
                ...
                <!-- Modal -->
                <div class="modal fade modal-terms" id="staticBackdrop" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                    <div class="modal-dialog modal-lg modal-dialog-scrollable">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h4 class="modal-title d-flex font-weight-bold text-center justify-content-center" id="staticBackdropLabel">Termos de Uso e Privacidade</h4>
                            ...
                            <div class="modal-body">
                                <div class="row justify-content-center pb-1">
                                    <div class="col-md-12 py-md-3 wrap-about pb-md-5" data-aos="fade-up">
                                        <div class="text-terms mt-md-1 pl-3 pr-3 text-justify">
                                            <p class="text-justify">As determinações abaixo representam um contrato entre você e a WINDX
                            ...
                            <div class="modal-footer">
                                ...
                                <a class="btn btn-primary" href="https://api.whatsapp.com/send?phone=558000282309&text=Tenho%20d%C3%BAvidas%20sobre%20os%20termos%20e%20privacidade%20do%20site">Dúvidas?</a>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="row div-title mt-0">
                    <div class="col-12">
                        <h3 class="page-title">Central do Assinante</h3>
                        <h5 class="page-subtitle">Termos de uso e privacidade</h5>
                    </div>
                    ...
                    <section>
                        <div class="contents">
                            ...
                            <div class="row justify-content-center pt-1 pb-1">
                                <div class="col-md-12 py-md-3 wrap-about pb-md-5" data-aos="fade-up">
                                    <div class="text-terms mt-md-3 pl-3 pr-3 text-justify">
                            ...
                            <div class="row justify-content-center p-3">
                                <p class="form-text text-center text-muted">
                                    Em caso de dúvida, clique <a class="help-link" href="https://api.whatsapp.com/send?phone=558000282309&text=Tenho%20d%C3%BAvidas%20sobre%20os%20termos%20e%20privacidade%20do%20site">aqui</a> para entrar em contato.
                                </p>
                            </div>
                        </div>
                    </section>
